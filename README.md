# 🌐 World Intelligence Platform v3.38
...
[![Dashboard](https://img.shields.io/badge/Dashboard-v3.38-a78bfa)](./dashboard/world-intelligence.html)
...
> **Real screenshots from the live running dashboard · v3.38 · Muhammad Umer Lari**
...
- [Overview](#-overview)
- [What's New v3.38](#-whats-new--v337)
...
> 📄 **Professional Use Cases:** See [`PLATFORM_EXECUTIVE_BRIEF.pdf`](./PLATFORM_EXECUTIVE_BRIEF.pdf) — where this platform is deployed, how it helps firms, and which consulting firms gain strategic advantage.
...
### 👶 Birth Rate & Demographics Sub-Tab (v3.38)
New Recession Intelligence sub-tab: **"Birth Rate & Demographics — Recession's Hidden Toll"**
- 5-phase timeline (Pre-Shock → Structural Reset): economy + demographics side-by-side per phase
- 8-country TFR comparison table (USA, Greece, Spain, Italy, Japan, Germany, S.Korea, Ukraine)
- 8 leading indicator signals with confidence ratings (CDC, NBER, OECD, Harvard JCHS)
- 4 "What Overcomes It" pillars (Economic, Policy, Society, Recovery Signal)
- Chart.js TFR time series 2000–2023 for 5 countries
- AI analysis button → MiniMax M2.7 on-demand narrative

### 🌿 Environment in Recession Sub-Tab (v3.38)
New Recession Intelligence sub-tab: **"Environment in Recession — Collapse & Recovery"**
- 5-phase environment breakdown (CO₂ / Air Quality / Water / Policy Risk per phase)
- 8-sector impact table: Steel, Aviation, Shipping, Auto, Construction, Energy, Agriculture, Tech
- 5 historical case studies: 2008 GFC, COVID-2020, 1970s Oil Crisis, Asian Crisis, Eurozone 2011
- CO₂ vs GDP growth Chart.js bar+line chart (1990–2023, recession years highlighted red)
- Sources: IEA, ESA Sentinel-5P, Global Carbon Project, EPA, UNEP, Yale EPI 2024

### 🌡 Climate in Recession Sub-Tab (v3.38)
New Recession Intelligence sub-tab: **"Climate & Recession — Crisis Within a Crisis"**
- Critical explainer: why short-term CO₂ cuts don't cool the planet (CO₂ atmospheric physics)
- Global temperature anomaly table 1950–2024 with recession year callouts (NASA GISS)
- 6 climate tipping points and how recession delays mitigation increases risk for each
- Net zero delay cost table: 4 recovery scenarios (Green vs Austerity vs Fossil vs Structural)
- Temperature anomaly Chart.js chart 1950–2024 with 1.5°C IPCC threshold line
- Sources: NASA GISS, NOAA NCEI, IPCC AR6, WMO, Global Carbon Project, IEA Net Zero 2050
...
│
├── dashboard/
│   └── world-intelligence.html        # Single-file dashboard (~773 KB · v3.38)
...
|-----------|---------|-------|--------|
| [TEST_v3.38.md](./TEST_v3.38.md) | v3.38 | 45 | ✅ All PASS |
...
Full development history — from v1.0 to v3.38.
...
| **Sprint 15** | v3.36 – v3.38 | G10 & World Impact | 10 country cards, forex analysis, trader playbooks, dev vs developing, G10 source footer |
...
|---------|------|-----------|
| **v3.38** | Jul 2025 | G10 source footer (28 verified links) · Professional README · LinkedIn showcase |
...
*World Intelligence Platform v3.38 · Free AI: MiniMax M2.7 · Zero paid APIs · Private repository*
